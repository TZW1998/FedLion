...
parser.add_argument('--lr', type=float, default=0.03, help='Local Learning rate')
parser.add_argument('--glr', type=float, default=3.3, help='Global Learning rate')
...
log_dir = 'logs/CIFAR/fedDA_exp{}_bz{}_lr{}_glr{}_mm{}_wd{}_nn{}_ls{}'.format(args.exp_index, batch_size, lr, glr, momentum, weight_decay, args.num_nodes, args.local_steps)
